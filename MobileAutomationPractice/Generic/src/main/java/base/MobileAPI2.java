...
public class MobileAPI2 {
    ...
    public static AppiumDriver getDriver(String OS, String deviceName, String version) throws IOException {
        ...
        if (OS.equalsIgnoreCase("Android")) {
            ...
            capabilities.setCapability(MobileCapabilityType.APP, "C:\\Users\\RACHID\\Documents\\GitHub\\MobileAutomationPractice\\Ebay\\src\\test\\resources\\Online Shopping Buy sell and save with eBay_v5.32.1.0_apkpure.com.apk");
